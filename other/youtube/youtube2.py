...
from tinkoff.invest import RequestError, OrderDirection, OrderType, Quotation
import creds
...
def run():
    ...
    try:
        ...
        with SandboxClient(TOKEN) as client:
            ...
            #     figi=FIGI,
            #     quantity=1,
            #     account_id="a9d1b0b4-af34-44e9-b556-9ee9fa82d511",
            #     direction=OrderDirection.ORDER_DIRECTION_BUY,
            #     order_type=OrderType.ORDER_TYPE_MARKET
            # )
            ...
            #
            # print(r, end="\n\n")
            # print(r.execution_report_status.__objclass__.__dict__)
